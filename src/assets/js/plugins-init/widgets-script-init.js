		...
		new Chart(chart_widget_11, {
			...
			data: {
				...
				datasets: [{
					...
					borderColor: '#F8C134',
					pointBackgroundColor: '#F8C134',
					pointBorderColor: '#F8C134',
					pointHoverBackgroundColor: '#F8C134',
					pointHoverBorderColor: '#F8C134',
		...
		if(jQuery('#chart_widget_17').length > 0 ){
			...
			new Chart(chart_widget_17, {
				...
				data: {
					...
					datasets: [{
						label: "Sales Stats",
						backgroundColor: ['#296086'],
						borderColor: '#296086',
						pointBackgroundColor: '#296086',
						pointBorderColor: '#296086',
						borderWidth:4,
						borderRadius:10,
